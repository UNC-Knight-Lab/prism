...
np.savetxt("m2_v2_70_rates.csv", rates, delimiter=",", fmt="%f")
np.savetxt("m2_v2_70_conv.csv",tot_conv)
np.savetxt("m2_v2_70_m1.csv",convA)
np.savetxt("m2_v2_70_m2.csv",convB)
