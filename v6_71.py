...
# np.savetxt("v6_71_rates.csv", rates, delimiter=",", fmt="%f")
# np.savetxt("v6_71_conv.csv",conv)
# np.savetxt("v6_71_m1.csv",m1)
# np.savetxt("v6_71_m2.csv",m2)
# np.savetxt("v6_71_m3.csv",m3)
