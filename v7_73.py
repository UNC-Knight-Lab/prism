...
# np.savetxt("v7_73_rates.csv", rates, delimiter=",", fmt="%f")
# np.savetxt("v7_73_conv.csv",conv)
# np.savetxt("v7_73_m1.csv",m1)
# np.savetxt("v7_73_m2.csv",m2)
# np.savetxt("v7_73_m3.csv",m3)

m1, m2, m3, conv = p.display_overlay([1.0,0.82,1.87,0.59,1.96,2.02], 150)
