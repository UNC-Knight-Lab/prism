...
np.savetxt("de_73_rates_constrained_loss.csv", rates, delimiter=",", fmt="%f")
np.savetxt("de_73_conv_constrained_loss.csv",conv)
np.savetxt("de_73_m1_constrained_loss.csv",m1)
np.savetxt("de_73_m2_constrained_loss.csv",m2)
np.savetxt("de_73_m3_constrained_loss.csv",m3)