...
# np.savetxt("run5_71_rates.csv", rates, delimiter=",", fmt="%f")
# np.savetxt("run5_71_conv.csv",conv)
# np.savetxt("run5_71_m1.csv",m1)
# np.savetxt("run5_71_m2.csv",m2)
# np.savetxt("run5_71_m3.csv",m3)

m1, m2, m3, conv = p.display_overlay([0.9,0.8,2,0.5,2,2], 150)
...
# p.test_values(0.5,0.5,2,0.5,2,2,20)